...
<body>
    <header class="flex justify-between items-center px-32 h-24 border-b-[1px] border-[#ed231a] bg-white">
            ...
            <?php if (isset($_SESSION["user"])) {
                if ($_SESSION["user"]["statut"] == "admin") { ?>
                    <form action="admin.php">
                        <button type="submit" id="admin" class="bg-white border-[1px] border-black px-2 py-1 rounded-lg text-xl hover:text-white" style="box-shadow: 8px 8px 5px #7e1d50;">Admin</button>
                    </form>
                <?php } ?>
                <form action="profil.php">
                    <button type="submit" id="profil" class="bg-white border-[1px] border-black px-2 py-1 rounded-lg text-xl hover:text-white" style="box-shadow: 8px 8px 5px #7e1d50;">Profil</button>
                </form>
                <form action="logout.php">
                    <button type="submit" id="deco" class="bg-white border-[1px] border-black px-2 py-1 rounded-lg text-xl hover:text-white" style="box-shadow: 8px 8px 5px #7e1d50;">Déconnexion</button>
                </form>
            <?php } else { ?>
                <form action="connexion.php">
                    <button type="submit" id="conn" class="bg-white border-[1px] border-black px-2 py-1 rounded-lg text-xl hover:text-white" style="box-shadow: 8px 8px 5px #7e1d50;">Connexion</button>
                </form>
            <?php } ?>
        </nav>
    </header>
    <main class="flex flex-col items-center bg-cover min-h-[75vh] bg-center bg-fixed bg-gray-300 pt-10 pb-10" style="background-image: url(https://static.vecteezy.com/ti/vecteur-libre/p3/265609-illustrationle-paysage-rouge-vectoriel.png)">
