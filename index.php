...
<body>
    ...
    <main class="flex flex-col items-center bg-cover bg-center bg-fixed bg-gray-300 pt-10 pb-10" style="background-image: url(https://static.vecteezy.com/ti/vecteur-libre/p3/265609-illustrationle-paysage-rouge-vectoriel.png)">
