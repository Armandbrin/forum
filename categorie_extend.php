...
<body>
    ...
    <main class="flex flex-col items-center pt-10 h-[75vh] bg-center bg-cover bg-fixed" style="background-image: url(https://static.vecteezy.com/ti/vecteur-libre/p3/265609-illustrationle-paysage-rouge-vectoriel.png)">
        <section class="bg-[#7e1d50] h-auto w-[60vw] mb-10 pb-2 rounded-lg border-white border-[1px]" style="box-shadow: 8px 8px 5px white;">
            <article class="mx-2 mt-2 rounded-t-lg p-1">
                <h2 class="text-white"><?= $sousCat[0]["name"] ?></h2>
            </article>
            <?php foreach ($bdd->getAllSousCategorie($idCat) as $sous_categorie) { ?>
                <section class="flex justify-between ">
                    <article class="bg-white mb-2 rounded-lg p-1 border-b-[1px] border-red-500 mx-2 w-full">
                        <a class="w-full" href="sous_categorie_extend.php?cat=<?= $sous_categorie[0] ?>">
