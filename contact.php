...
<body>
    ...
    <main class="flex flex-col items-center bg-cover bg-center bg-fixed bg-gray-300 pt-10 pb-10 min-h-[75.1vh]" style="background-image: url(https://static.vecteezy.com/ti/vecteur-libre/p3/265609-illustrationle-paysage-rouge-vectoriel.png)">
                <form class="bg-[#7e1d50] w-[50vw] flex flex-col items-center p-5 gap-3 border-2 border-white rounded-lg" style="box-shadow: 8px 8px 5px white;">
                    <input class="bg-white border-2 border-black rounded-lg w-full p-1" type="text" placeholder="Nom">
                    <input class="bg-white border-2 border-black rounded-lg w-full p-1" type="text" placeholder="Prenom">
                    <input class="bg-white border-2 border-black rounded-lg w-full p-1" type="email" placeholder="Email">
                    <textarea class="bg-white border-2 border-black rounded-lg p-1 w-full h-32 overflow-y-auto resize-none" placeholder="Contenue"></textarea>
                    <button class="bg-white border-2 border-black rounded-lg w-full p-1" type="submit">Envoyer</button>
                </form>
    </main>
